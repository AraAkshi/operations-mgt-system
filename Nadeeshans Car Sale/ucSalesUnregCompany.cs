...
{
    public partial class ucSalesUnregCompany : UserControl
    {
        private static ucSalesUnregCompany _instance;

        public static ucSalesUnregCompany Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new ucSalesUnregCompany();
                }
                return _instance;
            }
        }

        public ucSalesUnregCompany()
        {
            InitializeComponent();
        }

        private void ucSalesUnregCompany_Load(object sender, EventArgs e)
        {
        ...
        private void btnViewMore_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO tblcustomer VALUES (@customerName, @customerName, @address, 'BUYER', 'UNREG_COMPANY', @customerTel)";
